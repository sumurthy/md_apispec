module SpecMaker
	...
	HTTP_HEADER_SAMPLE = "| Authorization  |string | Oauth2 authorization code. Required.| " + NEWLINE + "| Workbook-Session-Id  |string |It is recommended to include the workbook session Id along with the request. Optional.|"
