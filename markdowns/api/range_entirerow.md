...
POST /workbook/bindings/<id>/range/EntireRow
POST /workbook/tables/<id|name>/range/EntireRow
...
```http
POST https://graph.microsoft.com/beta/workbook/names/<name>/range/EntireRow
```
