...
POST /workbook/bindings/<id>/table/columns/<id|name>/DataBodyRange
...
```http
POST https://graph.microsoft.com/beta/workbook/tables/<id|name>/columns/<id|name>/DataBodyRange
```
