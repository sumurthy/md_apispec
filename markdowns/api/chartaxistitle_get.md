...
|$expand|string|Comma-separated list of relationships to expand and include in the response. See relationships table of [ChartAxisTitle](../resources/chartaxistitle.md) object for supported names. |
...
```http
GET https://graph.microsoft.com/beta/workbook/worksheets/<id|name>/charts/<name>/axes/valueaxis/title
```
##### Response
