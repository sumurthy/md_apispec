...
POST /workbook/bindings/<id>/range/LastCell
POST /workbook/tables/<id|name>/range/LastCell
...
```http
POST https://graph.microsoft.com/beta/workbook/names/<name>/range/LastCell
```
